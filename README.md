...
First, add the plugin to your project by appending `addSbtPlugin("org.roboscala" % "sbt-robovm" % "1.14.0")`
...
addSbtPlugin("org.roboscala" % "sbt-robovm" % "1.14.0-YOUR_SUFFIX" changing())
```
